	...
	<div class="row">
		<div class="col-12 col-lg-8 offset-lg-2">
			...
			<!-- <p>
				<a href="http://twitter.com/givememydata" target="_blank"
					><img
						...
						alt="Twitter logo"
						style="width:30px; vertical-align:-10px" /> Follow Give Me My Data on Twitter</a>
			</p> -->

			<h2 id="code">Code</h2>

			<p><a href="https://github.com/omundy/givememydata">See github page</a></p>
			...
			<p>
				...
				><br /> -->
				<a
					href="http://www.bild.de/BILD/digital/internet/2010/05/22/facebook/peinliche-postings-zum-schaemen.html"
					target="_blank">Die peinlichsten Einträge bei Facebook, StudiVZ und Twitter</a
				><br />
				English:
